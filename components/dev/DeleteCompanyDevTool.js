// Local-development-only shortcut for deleting test companies. Links to
// /dev/delete-company - no deletion logic lives here, this is purely a
// visibility/navigation shortcut.
//
// To remove this tool entirely later: delete this file, delete
// pages/dev/delete-company.js and pages/api/dev/delete-company.js, and
// remove the one import + render line in pages/_app.js.
import Link from "next/link";
import { useEffect, useState } from "react";
import { isLocalDev } from "../../lib/isLocalDev";

export default function DeleteCompanyDevTool() {
